USE [valeant]
GO
/****** Object:  Table [valeant].[matrix_version_3]    Script Date: 4/26/2016 11:12:50 PM ******/
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (94, 1, 2, N'iif(owner.FlagOne AND action.Equals("Создать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (95, 1, 3, N'iif(owner.FlagOne AND action.Equals("Отправить", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (96, 2, 4, N'iif(owner.FlagOne AND action.Equals("Аннулировать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (97, 2, 3, N'iif(owner.FlagOne AND action.Equals("Отправить", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (98, 2, 2, N'iif(owner.FlagOne AND action.Equals("Сохранить", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (99, 5, 2, N'iif(owner.FlagOne AND action.Equals("Сохранить", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (101, 5, 3, N'iif(owner.FlagOne AND action.Equals("Отправить", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (102, 3, 30, N'iif(owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (103, 3, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (105, 3, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (108, 8, 31, N'iif(NOT document.IsFlagAccountant AND owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (109, 8, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (111, 8, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (114, 32, 12, N'iif(owner.FlagOne AND document.CheckHwoIs(), true, false)', 4, NULL, NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (115, 32, 26, N'iif(owner.FlagOne AND document.CheckHwoIs(), false, true)', 4, NULL, NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (124, 28, 29, N'iif(owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = true', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (125, 28, 8, N'iif(owner.FlagOne AND action.Equals("Дополнительное согласование", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = true', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (126, 28, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (132, 27, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (133, 27, 4, N'iif(owner.FlagOne AND action.Equals("Отказать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (134, 27, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (136, 29, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (137, 29, 4, N'iif(owner.FlagOne AND action.Equals("Отказать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (138, 29, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 4, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (141, 2, 4, N'iif(owner.FlagOne AND action.Equals("Аннулировать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (142, 2, 3, N'iif(owner.FlagOne AND action.Equals("Отправить", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (144, 5, 2, N'iif(owner.FlagOne AND action.Equals("Сохранить", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (145, 5, 4, N'iif(owner.FlagOne AND action.Equals("Аннулировать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (146, 5, 3, N'iif(owner.FlagOne AND action.Equals("Отправить", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (147, 3, 30, N'iif(owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (148, 3, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (150, 3, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (153, 8, 31, N'iif(NOT document.IsFlagAccountant AND owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (154, 8, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (156, 8, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (169, 9, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 1)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (170, 9, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (175, 28, 29, N'iif(owner.FlagOne AND action.Equals("Согласовать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = true', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (176, 28, 8, N'iif(owner.FlagOne AND action.Equals("Дополнительное согласование", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = true', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (177, 28, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (183, 27, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (184, 27, 4, N'iif(owner.FlagOne AND action.Equals("Отказать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (185, 27, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
...
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (187, 29, 5, N'iif(owner.FlagOne AND action.Equals("На доработку", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (188, 29, 4, N'iif(owner.FlagOne AND action.Equals("Отказать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
INSERT [valeant].[matrix_version_3] ([id], [from], [to], [condition], [document], [postfunc], [approvalsheetitem], [clearapprovalsheet]) VALUES (189, 29, 2, N'iif(owner.FlagOne AND action.Equals("Отозвать", StringComparison.InvariantCultureIgnoreCase), true, false)', 5, N'document.IsFlagAccountant = false', NULL, 0)
GO
