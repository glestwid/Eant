...
namespace Valeant.Sp.UprsWeb.Controllers
{
    ...
    public class LoadFrom1CController : JsonNetController
    {
        ...
        public async Task<JsonResult> loadData([ModelBinder(typeof(JsonNetModelBinder))] LoadData item)
        {
            ...
            //Task t = Valeant.Sp.Uprs.Structure.Loader.Loader.Load(inputStream, false, "сотрудник");
            //return await Valeant.Sp.Uprs.Structure.Loader.Loader.Load(inputStream, false, "сотрудник");
            return await Task.Run(() =>
            {
                if (item.Data == null)
                    return Json(false);
                ...
                // TODO возвращать из хранимой процедуры кол-во записей
                recCount = Valeant.Sp.Uprs.Structure.Loader.Loader.Load(inputStream, false, "сотрудник").Result;
                //Valeant.Sp.Uprs.Structure.Loader.Loader.Load(inputStream, false, "сотрудник").Wait();

                string message = "Данные из 1С загружены.";
                //if (recCount > 0)
