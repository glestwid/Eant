angular.module("valeant.controllers")
    ...
    .controller("VehicleTypesController", function ($scope, $http, toastr, $uibModal, $appConfig) {
        $scope.gridOptions = {
            data: "data",
            enableSorting: false,
            ...
            columnDefs: [
                { name: "Вид транспорта", field: "Name" },
            ...
            appScopeProvider: {
                ...
                editRow: function (grid, row) {
                    var modalInstance = $uibModal.open({
                        templateUrl: "app/templates/settings/modals/editVehicleTypeModal.html",
        ...
        $scope.reload = function () {
            $http({
                ...
                $scope.data = response;
                if ($appConfig.showSuccessToastr)
                    toastr.success("Данные видов транспорта получены!");
            }).error(function (error) {
                toastr.error("Ошибка!");
                throw error;
            });
