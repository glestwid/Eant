...
namespace Valeant.Sp.Uprs.Structure.Loader.Domain
{
    ...
    public sealed class ValeantCountryOrganizationContractorContract {
        /// <summary>
        ...
        public ValeantCountryOrganizationContractorContract Clone() {
            return ((ValeantCountryOrganizationContractorContract)(MemberwiseClone()));
        }
    }
}
